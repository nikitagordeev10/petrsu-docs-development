...
class MainConfigSchema {
	 ...
	 *
	 * Defaults to "$wgResourceBasePath/resources/assets/petrsu-logo-blue-135.svg".
	...
	public static function getDefaultLogo( $resourceBasePath ): string {
		return "$resourceBasePath/resources/assets/petrsu-logo-blue-135.svg";
	}
	 ...
	 *   or [ "1x" => "$wgResourceBasePath/resources/assets/petrsu-logo-blue-135.svg" ] if $wgLogo is not set.
	 * @since 1.35
	 */
	public const Logos = [
		'default' => false,
