...
class MessageTest extends MediaWikiLangTestCase {
	...
	public function testInLanguage() {
		...
		$this->assertSame( 'Главная страница',
	...
	public function testRawParams() {
		$this->assertSame(
			'(Главная страница)',
			wfMessage( 'parentheses', 'Главная страница' )->plain()
		);
		$this->assertSame(
			'(Главная страница $1)',
			wfMessage( 'parentheses', 'Главная страница $1' )->plain()
		);
		$this->assertSame(
			'(Главная страница)',
			wfMessage( 'parentheses' )->rawParams( 'Главная страница' )->plain()
		);
		$this->assertSame(
			'(Главная страница $1)',
			wfMessage( 'parentheses' )->rawParams( 'Главная страница $1' )->plain()
		);
	}
